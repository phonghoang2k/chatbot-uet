module.exports = {
    ...
    WAITING: '[BOT] Đang tìm partner... Nếu bạn muốn đổi giới tính, gửi ketthuc sau đó chọn giới tính mới.',

    START_OKAY: '[BOT] OK! Chúng mình sẽ thông báo khi match nhé.',
    START_CHAT: '[BOT] Connected! Nếu muốn kết thúc, hãy gửi ketthuc\nChúc 2 bạn nói chuyện vui vẻ, cẩn thận bị lừa :)',
    ...
    ERR_TOO_LONG: '[Chatbot] Oops: tin nhắn bạn gửi quá dài (nhiều hơn 640 ký tự). Hãy chia nhỏ tin nhắn và gửi dần ha.',
